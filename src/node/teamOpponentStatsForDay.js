...
const insertData = (dataToInsert) => {
  ...
  mongodb.MongoClient.connect(
    ...
    (err, client) => {
      ...
      const collection = db.collection('teamOpponentStatsByDay');
